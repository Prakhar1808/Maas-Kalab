...
> = {
  "1": {
    ...
    images: [
      { src: "/maashack_page/one/maashack_1.png", caption: ""},
      { src: "/maashack_page/one/ashwani.png", caption: ""},
      { src: "/maashack_page/one/chicken_fry.png", caption: ""},
      { src: "/maashack_page/one/jama_masjid.png", caption: ""},
    ],
  },
  "2": {
    title: "Maas Hack 2.0",
    ...
    images: [
      { src: "/maashack_page/two/maashack_2.png", caption: ""},
      { src: "/maashack_page/two/three_gng.png", caption: ""},
      { src: "/maashack_page/two/mandi.png", caption: ""},
      { src: "/maashack_page/two/gng_again.png", caption: ""},
      { src: "/maashack_page/two/chai.png", caption: ""},
      { src: "/maashack_page/two/car.png", caption: ""},
    ],
  },
  "3": {
    title: "Maas Hack 3.0",
    ...
    locationhref: "https://maps.app.goo.gl/eDWUVSp9DUSPJSSM9",
    images: [
      { src: "/maashack_page/three/maashack_3.png", caption: "" },
      { src: "/maashack_page/three/tea.png", caption: "" },
      { src: "/maashack_page/three/gng_at_nihari.png", caption: "" },
      { src: "/maashack_page/three/seekh_kebab.png", caption: "" },
      { src: "/maashack_page/three/mas.png", caption: "" },
      { src: "/maashack_page/three/fish_fry.png", caption: "" },
      { src: "/maashack_page/three/shwarma.png", caption: "" },
      { src: "/maashack_page/three/nihari.png", caption: "" },
      { src: "/maashack_page/three/nihari_on_plate.png", caption: "" }
    ],
  },
  "4": {
    title: "Maas Hack 4.0",
    ...
    images: [
      { src: "/maashack_page/four/maashack_4.png", caption: "" },
      { src: "/maashack_page/four/afsar.png", caption: "" },
      { src: "/maashack_page/four/crowd.png", caption: "" },
      { src: "/maashack_page/four/cutw_uncle.png", caption: "" },
      { src: "/maashack_page/four/dogi.png", caption: "" },
      { src: "/maashack_page/four/drinking_and_shi.png", caption: "" },
      { src: "/maashack_page/four/fruit.png", caption: "" },
      { src: "/maashack_page/four/zkn.png", caption: "" },
      { src: "/maashack_page/four/mosque.png", caption: "" },
      { src: "/maashack_page/four/peak_on_plate.png", caption: "" },
      { src: "/maashack_page/four/peak.png", caption: "" },
      { src: "/maashack_page/four/roasted_again.png", caption: "" },
      { src: "/maashack_page/four/roasted.png", caption: "" },
      { src: "/maashack_page/four/sweety.png", caption: "" },
      { src: "/maashack_page/four/we_ate.png", caption: "" }
    ],
  },
};
